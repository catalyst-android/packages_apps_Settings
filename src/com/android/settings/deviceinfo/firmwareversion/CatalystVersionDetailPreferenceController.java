...
public class CatalystVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "CatalystVersionDialogCtrl";
    ...
    private static final String KEY_CATALYST_ZIPTYPE_PROP = "ro.catalyst.ziptype";
    ...
    public CatalystVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
